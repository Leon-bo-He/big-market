...
# Database: big_market
# Generation Time: 2024-06-23 11:51:54 +0000
# ************************************************************
...
VALUES
	(1,10001,101,'Random Points',NULL,80000,80000,80.0000,'rule_random, rule_luck_award',1,'2024-06-23 17:47:00','2024-06-23 17:49:25'),
...
CREATE TABLE `strategy_rule` (
  ...
  `rule_model` varchar(16) NOT NULL COMMENT 'rule_random -> random value; rule_lock -> unlock after playing; rule_luck_award -> consulation prize.',
...
VALUES
	(1,10001,101,2,'rule_random','1,1000','random points strategy','2024-06-23 19:35:07','2024-06-23 19:35:07'),
	...
	(5,10001,107,2,'rule_luck_award','1,100','random point less than 100 - consulation prize','2024-06-23 19:38:06','2024-06-23 19:39:08'),
	(6,10001,108,2,'rule_luck_award','1,100','random point less than 100 - consulation prize','2024-06-23 19:38:06','2024-06-23 19:39:08'),
	(7,10001,101,2,'rule_luck_award','1,10','random point less than 10 - consulation prize','2024-06-23 19:38:06','2024-06-23 19:39:08'),
	(8,10001,102,2,'rule_luck_award','1,20','random point less than 20 - consulation prize','2024-06-23 19:38:06','2024-06-23 19:40:44'),
	(9,10001,103,2,'rule_luck_award','1,30','random point less than 30 - consulation prize','2024-06-23 19:38:06','2024-06-23 19:40:44'),
	(10,10001,104,2,'rule_luck_award','1,40','random point less than 40 - consulation prize','2024-06-23 19:38:06','2024-06-23 19:40:44'),
	(11,10001,105,2,'rule_luck_award','1,50','random point less than 50 - consulation prize','2024-06-23 19:38:06','2024-06-23 19:41:53'),
	(12,10001,106,2,'rule_luck_award','1,60','random point less than 60 - consulation prize','2024-06-23 19:38:06','2024-06-23 19:41:53'),
	(13,10001,NULL,1,'rule_weight','6000,102,103,104,105,106,107,108,109','If used 6000 points, must choose one from these awards','2024-06-23 19:43:50','2024-06-23 19:44:13'),
	(14,10001,NULL,1,'rule_blacklist','1','Blacklist user, 1 point for each round','2024-06-23 19:44:52','2024-06-23 19:44:52');
