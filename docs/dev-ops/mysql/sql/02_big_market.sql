...
VALUES
	...
	(5,9015,100301,11105,100000,100000,9.99,'2025-06-04 09:15:33','2025-06-04 10:38:33'),
...
VALUES
	(1,'tree_lock_15','rule_tree','rule_tree','rule_lock','2025-06-04 09:15:33','2025-06-04 09:15:33'),
	(2,'tree_luck_award','rule_tree_fallback_prize','rule_tree_fallback_prize','rule_stock','2025-06-04 09:15:33','2025-06-04 09:15:33'),
	(3,'tree_lock_50','rule_tree','rule_tree','rule_lock','2025-06-04 09:15:33','2025-06-04 10:44:58'),
	(4,'tree_lock_100','rule_tree','rule_tree','rule_lock','2025-06-04 09:15:33','2025-06-04 10:45:01');
...
VALUES
	(1,'tree_lock_15','rule_lock','unlock certain award as the user completes N times of lottery','15','2025-06-04 09:15:33','2025-06-04 09:15:33'),
	(2,'tree_lock_15','rule_luck_award','random points - fallback prize','101:1,100','2025-06-04 09:15:33','2025-06-04 09:15:33'),
	(3,'tree_lock_15','rule_stock','stock deduction rule',NULL,'2025-06-04 09:15:33','2025-06-04 09:15:33'),
	...
	(6,'tree_lock_50','rule_lock','unlock certain award as the user completes N times of lottery','50','2025-06-04 09:15:33','2025-06-04 10:45:13'),
	(7,'tree_lock_50','rule_luck_award','random points - fallback prize','101:1,100','2025-06-04 09:15:33','2025-06-04 10:45:09'),
	(8,'tree_lock_50','rule_stock','stock deduction rule',NULL,'2025-06-04 09:15:33','2025-06-04 10:45:11'),
	(9,'tree_lock_100','rule_lock','unlock certain award as the user completes N times of lottery','100','2025-06-04 09:15:33','2025-06-04 10:45:55'),
	(10,'tree_lock_100','rule_luck_award','random points - fallback prize','101:1,100','2025-06-04 09:15:33','2025-06-04 10:45:50'),
	(11,'tree_lock_100','rule_stock','stock deduction rule',NULL,'2025-06-04 09:15:33','2025-06-04 10:45:52');
...
VALUES
	(1,'tree_lock_15','rule_lock','rule_stock','EQUAL','ALLOW','2025-06-04 09:15:33','2025-06-04 09:15:33'),
	(2,'tree_lock_15','rule_lock','rule_luck_award','EQUAL','TAKE_OVER','2025-06-04 09:15:33','2025-06-04 09:15:33'),
	(3,'tree_lock_15','rule_stock','rule_luck_award','EQUAL','ALLOW','2025-06-04 09:15:33','2025-06-04 09:15:33'),
	(4,'tree_luck_award','rule_stock','rule_luck_award','EQUAL','ALLOW','2025-06-04 09:15:33','2025-06-04 09:15:33'),
	(5,'tree_lock_50','rule_lock','rule_stock','EQUAL','ALLOW','2025-06-04 09:15:33','2025-06-04 10:46:11'),
	(6,'tree_lock_50','rule_lock','rule_luck_award','EQUAL','TAKE_OVER','2025-06-04 09:15:33','2025-06-04 10:46:13'),
	(7,'tree_lock_50','rule_stock','rule_luck_award','EQUAL','ALLOW','2025-06-04 09:15:33','2025-06-04 10:46:15'),
	(8,'tree_lock_100','rule_lock','rule_luck_award','EQUAL','ALLOW','2025-06-04 09:15:33','2025-06-04 10:46:17'),
	(9,'tree_lock_100','rule_lock','rule_luck_award','EQUAL','TAKE_OVER','2025-06-04 09:15:33','2025-06-04 10:46:20'),
	(10,'tree_lock_100','rule_stock','rule_luck_award','EQUAL','ALLOW','2025-06-04 09:15:33','2025-06-04 10:46:22');
...
VALUES
	...
	(7,100001,107,'Noise-Canceling Headphones','Stay focused with premium over-ear noise-cancelers.',200,200,0.0400,'tree_lock_15',7,'2025-06-04 09:15:33','2025-06-04 11:02:40'),
	(8,100001,108,'Ergonomic Desk Setup','Adjustable standing desk with accessories.',199,199,0.0078,'tree_lock_50',8,'2025-06-04 09:15:33','2025-06-04 11:03:23'),
	(9,100001,109,'MacBook Pro','Top-tier performance MacBook for tech creators.',10,10,0.0022,'tree_lock_100',9,'2025-06-04 09:15:33','2025-06-04 11:03:26'),
	...
	(13,100002,113,'Startup Legal Consultation','One-on-one legal support for founders and startups.',80000,80000,0.2000,'tree_lock_15',4,'2025-06-04 11:04:49','2025-06-04 11:08:14'),
	(14,100002,114,'DevOps Pipeline Checkup','Optimize your CI/CD and deployment workflow.',40000,40000,0.1000,'tree_lock_50',5,'2025-06-04 11:04:49','2025-06-04 11:08:29'),
	(15,100002,115,'CRM Pro Plan Access','Free 1-month access to a top-tier CRM platform.',40000,40000,0.1000,'tree_lock_100',6,'2025-06-04 11:04:49','2025-06-04 11:08:43');
