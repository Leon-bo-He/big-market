...
public class RaffleActivityPartakeService extends AbstractRaffleActivityPartake {
    ...
    protected CreatePartakeOrderAggregate doFilterAccount(String userId, Long activityId, Date currentDate) {
        // query total account quota
        ActivityAccountEntity activityAccountEntity = activityRepository.queryActivityAccountByUserId(userId, activityId);

        // quota check (only check total remaining quota)
        ...
        // create monthly account quota; true = exists monthly account, false = does not exist monthly account
        ...
        // create daily account quota; true = exists daily account, false = does not exist daily account
